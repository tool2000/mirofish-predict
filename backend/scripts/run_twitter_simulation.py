"""
OASIS Twitter 시뮬레이션 실행 스크립트.

기능:
- 설정 파일을 읽어 Twitter 시뮬레이션 실행
...
async def main():
    parser = argparse.ArgumentParser(description='OASIS Twitter 시뮬레이션 실행')
    parser.add_argument(
        '--config', 
        type=str, 
        required=True,
